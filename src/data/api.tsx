...
export const frontend = ENV === "dev" ? "http://dev-sierra-frontend.s3-website-ap-southeast-2.amazonaws.com" : "http://sierra-frontend.s3-website-ap-southeast-2.amazonaws.com";
